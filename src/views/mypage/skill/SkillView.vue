...
onMounted(async()=>{
    const id = stoAuth.info.id ? stoAuth.info.id : -1;
    await stoAuth.authExtend().then(()=>{
        stoProfile.getSkillCount();
        stoProfile.getUserSkillCount(id)
        stoProfile.getFollowing(id)
        stoProfile.getFollower(id)
    });
})
        ...
        <div class="con">
            ...
            <span>
                ...
                <span>
                    ...
                    {{
                        stoAuth.info.stance ? 
                        stoAuth.info.stance == 'Regular' ? '레귤러 스탠스' : '구피 스탠스' : '스탠스 없음'
                    }}
                </span>
            </span>
            <ul class="skill_list">
